...
from .personalSpace import CompanyPersonalSpace, StudentPersonalSpace, GetType
...
def initialize_routes(api):
    ...
    api.add_resource(CompanyPersonalSpace, '/api/personalSpace/student')
